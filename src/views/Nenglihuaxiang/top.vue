<template>
    <div class="box">
      ...
      <div class="info">
      <h2 class="top-title">能力画像</h2>
        <table>
          <tr>
            <td class="td1"><p>姓名：<strong>{{ information.username }}</strong></p></td> <td class="td2"> <p>学院：<strong>{{ information.college }}</strong></p></td>
          </tr>
          <tr>
            <td class="td1"><p>专业：<strong>{{ information.speciality }}</strong></p></td><td class="td2"><p>年级：<strong>{{ information.rank }}</strong></p></td>
          </tr>
        </table>
      </div>
    </div>

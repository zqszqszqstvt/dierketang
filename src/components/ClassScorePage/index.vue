<template>
  ...
  <script>
  import ClassScoreTop from '../ClassScoreTop'
  import ClassScoreCommit from '../ClassScoreCommit'
  import ClassScoreItem from '../ClassScoreItem'
  import ClassScoreCapacity from '../ClassScoreCapacity'
  export default {
    name: 'ClassScorePage',
    data() {
      return {

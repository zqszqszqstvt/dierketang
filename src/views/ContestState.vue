<template>
  <div>
    <el-row v-for="record in records" :key="record.contestId"
            :gutter="20" style="margin-bottom: 20px;margin-left: 15px">
      <el-col :span="6">
      ...
      <el-col :span="12">
        <div class="contest-introduce">
          ...
          <div class="contest-time" style="font-size: 10px">
...
export default {
  props:["state","contestName"],
  name: "ContestState",
  data(){
    return {
      url:'/contest/queryContest/1/10',
      records:[]
    }
  },
  components:{
  ...
  methods:{
    loadData(num,size){
      instance.get('/contest/queryContest/'+num+'/'+size,{
        headers:{
